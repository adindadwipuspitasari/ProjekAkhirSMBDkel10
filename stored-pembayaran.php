...
$stored_bayar2 = "CALL tampilkan_pembayaran(1, 5);";
$result_bayar2 = mysqli_query($koneksi, $stored_bayar2);
...
$bayar2 = mysqli_fetch_all($result_bayar2, MYSQLI_ASSOC);

// Membebaskan hasil dari memori
mysqli_free_result($result_bayar2);
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="stored-pembayaran.php">Pembayaran</a>
