...
$stored_peminjaman3 = "CALL tampilkan_laporan_peminjaman();";
$result_peminjaman3 = mysqli_query($koneksi, $stored_peminjaman3);

// Memeriksa apakah query berhasil dijalankan
if (!$result_peminjaman3) {
    die("Query untuk mengambil data barang gagal: " . mysqli_error($koneksi));
}

// Memuat data peminjaman ke dalam array
$peminjaman3 = mysqli_fetch_all($result_peminjaman3, MYSQLI_ASSOC);

// Membebaskan hasil dari memori
mysqli_free_result($result_peminjaman3);
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="stored-peminjaman.php">Peminjaman</a>
