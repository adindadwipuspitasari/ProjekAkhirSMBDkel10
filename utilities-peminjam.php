...
$query_peminjam = "SELECT * FROM peminjam";
$result_peminjam = mysqli_query($koneksi, $query_peminjam);

// Memeriksa apakah query berhasil dijalankan
if (!$result_peminjam) {
    die("Query untuk mengambil data peminjam gagal");
}

// Memuat data peminjaman ke dalam array
$peminjam = mysqli_fetch_all($result_peminjam, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="utilities-peminjam.php">Peminjam</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
					<h1 class="h3 mb-1 text-gray-800">Daftar Peminjam</h1>  
