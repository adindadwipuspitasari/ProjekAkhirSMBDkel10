...
$view_bayar = "SELECT * FROM infopembayaran";
$result_bayar = mysqli_query($koneksi, $view_bayar);
...
$bayar= mysqli_fetch_all($result_bayar, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
             ...
             <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="view-pembayaran.php">infopembayaran</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
					<h1 class="h3 mb-1 text-gray-800">View Pembayaran</h1>  
