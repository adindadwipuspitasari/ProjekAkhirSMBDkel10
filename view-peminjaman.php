...
$view_peminjaman1 = "SELECT * FROM infopeminjaman";
$result_peminjaman1 = mysqli_query($koneksi, $view_peminjaman1);

// Memeriksa apakah query berhasil dijalankan
if (!$result_peminjaman1) {
    die("Query untuk mengambil data barang gagal");
}

// Memuat data peminjaman ke dalam array
$peminjaman1= mysqli_fetch_all($result_peminjaman1, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Trigger</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="view-peminjaman.php">infopeminjaman</a>
                        <a class="collapse-item" href="view-transaksi.php">infotransaksi</a>
                        <a class="collapse-item" href="view-barang.php">new_barang</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
					<h1 class="h3 mb-1 text-gray-800">View Peminjaman</h1>  
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									>
										...
										<tbody>
											<?php $id_transaksi=1;?>
											<?php foreach ($peminjaman1 as $row): ?>
												<tr>
