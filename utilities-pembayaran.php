...
if (!$result_pembayaran) {
    die("Query untuk mengambil data pembayaran gagal");
}

// Memuat data peminjaman ke dalam array
$pembayaran = mysqli_fetch_all($result_pembayaran, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-peminjam.php">Peminjam</a>
                        <a class="collapse-item" href="utilities-barang.php">Barang</a>
                        <a class="collapse-item active" href="utilities-pembayaran.php">Pembayaran</a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                      ...
                      <!-- Topbar Search -->
					<h1 class="h3 mb-1 text-gray-800">Daftar Pembayaran</h1>  
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Pembayaran</h1>
