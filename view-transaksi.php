...
$view_transaksi = "SELECT * FROM infotransaksi";
$result_transaksi = mysqli_query($koneksi, $view_transaksi);
             ...
             <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="view-transaksi.php">infotransaksi</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
					<h1 class="h3 mb-1 text-gray-800">View Transaksi</h1>  
