...
$stored_barang2 = "CALL semua_barang(NULL);";
$result_barang2 = mysqli_query($koneksi, $stored_barang2);

// Memeriksa apakah query berhasil dijalankan
if (!$result_barang2) {
    die("Query untuk mengambil data barang gagal: " . mysqli_error($koneksi));
}

// Memuat data peminjaman ke dalam array
$barang2 = mysqli_fetch_all($result_barang2, MYSQLI_ASSOC);

// Membebaskan hasil dari memori
mysqli_free_result($result_barang2);
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="stored-barang.php">Barang</a>
                    ...
                    <table class="table">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['jumlah_stok']; ?></td> <!-- Ubah menjadi 'jumlah_stok' -->
