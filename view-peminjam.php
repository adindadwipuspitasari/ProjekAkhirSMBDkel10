...
$view_peminjam1= "SELECT * FROM new_peminjam";
$result_peminjam1 = mysqli_query($koneksi, $view_peminjam1);
...
$peminjam1= mysqli_fetch_all($result_peminjam1, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
             ...
             <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="view-peminjam.php">new_peminjam</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
					<h1 class="h3 mb-1 text-gray-800">View Peminjam</h1>  
